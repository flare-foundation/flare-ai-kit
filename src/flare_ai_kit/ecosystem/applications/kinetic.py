...
class Kinetic:
    ...
    async def supply(self, token: str, amount_WEI: int) -> str:
        """
    ...
    async def withdraw(self, token: str, amount_WEI: int) -> str:
        """
        Withdraw a specified amount of tokens from a Kinetic lending contract.

        This method builds a transaction to call the enterMarkets function (intended to redeem underlying tokens),
        simulates the transaction, and executes it on the Flare blockchain.
