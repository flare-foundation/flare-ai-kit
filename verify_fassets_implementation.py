...
def check_method_signature(cls: Any, method_name: str, expected_params: list[str]) -> bool:
...
async def test_initialization():
    ...
    try:
        ...
        required_attrs = [
            'asset_managers', 'supported_fassets', 'fasset_contracts', 
            'sparkdex_router', 'contracts', 'is_testnet'
        ]
...
def test_method_signatures():
    ...
    required_methods = {
        ...
        'swap_fasset_for_native': ['fasset_type', 'amount_in', 'amount_out_min', 'deadline'],
        'swap_native_for_fasset': ['fasset_type', 'amount_out_min', 'deadline', 'amount_in'],
        'swap_fasset_for_fasset': ['fasset_from', 'fasset_to', 'amount_in', 'amount_out_min', 'deadline'],
        
        # Minting workflow
        'reserve_collateral': ['fasset_type', 'agent_vault', 'lots', 'max_minting_fee_bips', 'executor'],
        'execute_minting': ['fasset_type', 'collateral_reservation_id', 'payment_reference', 'recipient'],
        
        # Redemption workflow
        'redeem_from_agent': ['fasset_type', 'lots', 'max_redemption_fee_bips', 'underlying_address', 'executor'],
