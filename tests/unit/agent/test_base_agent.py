...
class TestBaseAgent:
    ...
    def test_agent_context_validation(self):
        ...
        # Test valid context
        context = AgentContext(agent_id="test", agent_name="Test Agent")
    ...
    def test_update_context(self):
        ...
        # Update context
        agent.update_context(system_prompt="New prompt", max_history_length=100)
    ...
    def test_build_conversation_context(self):
        ...
        agent = self.MockAgent(
            "test-agent", "Test Agent", system_prompt="System prompt"
        )
        ...
        agent._add_to_history(
            ConversationMessage(role="system", content="System message")
        )
...
class TestAgentResponse:
    ...
    def test_response_creation(self):
        ...
        response = AgentResponse(content="Hello there!", agent_id="test-agent")
    ...
    def test_response_with_usage_info(self):
        ...
        usage_info = {"input_tokens": 10, "output_tokens": 5, "total_tokens": 15}

        response = AgentResponse(
            content="Response", agent_id="test-agent", usage_info=usage_info
        )
