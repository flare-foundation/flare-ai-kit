...
from flare_ai_kit.agent.base import AgentResponse, AgentError
...
class TestGeminiAgent:
    ...
    def test_gemini_agent_default_settings(self):
        ...
        with patch('flare_ai_kit.agent.gemini_agent.AgentSettings') as mock_settings_class:
    ...
    async def test_generate_response_with_history(self, gemini_agent):
        ...
        gemini_agent._add_to_history(ConversationMessage(role="assistant", content="Hello!"))
